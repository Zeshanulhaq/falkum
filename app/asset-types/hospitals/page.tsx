  ...
  return (
    <>
      <section className="px-4 pt-12 pb-10 max-w-7xl mx-auto">
        ...
        <h1 className="text-3xl md:text-5xl font-bold text-[#c9a84c] mb-4 leading-tight max-w-2xl">{h.title}</h1>
        <p className="text-[#888] text-sm sm:text-base leading-relaxed max-w-2xl">{h.subtitle}</p>
      </section>
      ...
      <section className="px-4 py-14 border-t border-[#1e1e1e]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">{h.assetFocus.title}</h2>
            <p className="text-[#888] text-sm leading-relaxed mb-6">{h.assetFocus.desc}</p>
          ...
          <ImagePlaceholder aspectRatio="aspect-[4/3]" label="Hospital / Medical Center" />
        </div>
      </section>
